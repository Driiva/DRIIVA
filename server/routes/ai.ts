 ...
 *
 * Both call a hosted model over fetch with a server-held key. The coach is
 * rate limited per user (coachLimiter, 5 req/min, distributed-safe) because
 * every call costs money and the request body is driver-controlled.
 */
