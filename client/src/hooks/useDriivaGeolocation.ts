...
import {
  GEO_CAPTURE_VERSION,
  MAX_VALID_SPEED_MS,
  MAX_TELEPORT_SPEED_MS,
  STATIONARY_POLL_MS,
  type DriivaGeoPoint,
  type GeoStatus,
  type UseDriivaGeolocationOptions,
  type UseDriivaGeolocationResult,
} from './driivaGeolocationContract';

// The tuning constants and the hook's shapes live in
// ./driivaGeolocationContract; re-exported here because callers have always
