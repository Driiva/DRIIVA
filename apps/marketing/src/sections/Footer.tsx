...
const LINKS: readonly FooterLink[] = [
  ...
  { href: '/cookies', label: 'Cookies', ariaLabel: 'Cookies policy' },
  { href: '/complaints', label: 'Complaints', ariaLabel: 'Complaints procedure' },
] as const;

const SOCIALS = [
  {
    href: 'https://x.com/driiva_ai',
    label: 'X',
    path: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z',
  },
  {
    href: 'https://www.instagram.com/driiva',
    label: 'Instagram',
  ...
  {
    href: 'https://www.tiktok.com/@driiva_ai',
    label: 'TikTok',
    ...
    <footer data-section="footer">
      <div className="container footer-inner">
        ...
        <div className="footer-links">
          {LINKS.map((l) => (
            <Link key={l.href} href={l.href} className="footer-link" aria-label={l.ariaLabel}>
              {l.label}
            </Link>
          ))}
      ...
      <div className="container footer-fineprint">
        <p>
          Driiva Technologies Ltd. is in the FCA Regulatory Sandbox application phase and is not
