...
const STEPS: readonly Step[] = [
  ...
  },
  {
    ...
    body: 'Our AI scores every trip across speed, braking, cornering, phone use, and night driving. Every factor, every weight, visible.',
  },
  {
    num: '03 · Score',
    ...
    <section ref={ref} id="how-it-works" data-section="how-it-works">
      <div className="container">
        <div className="section-head reveal-init">
          <span className="eyebrow-mini">How it works</span>
          <h2>Four steps. Two hands on the wheel.</h2>
