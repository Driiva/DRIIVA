 ...
 * build step. Their vitest wrappers used to reach them behind a
 * @ts-expect-error; declaring the surface here removes the need for that and
 * makes the shape the wrappers assert against a checked one rather than a
