...
- [ ] Accelerometer duty cycle (review finding 7). It runs at 5 Hz for as long as detection is armed, all day, and its only job while IDLE is to shorten the start hold from 20s to 10s. Poor trade for a battery - *raised by `e7febe2`, noted next to the constants*
